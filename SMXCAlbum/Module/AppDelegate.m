...
@property(nonatomic,strong) LKSMXCTabBarController *tabBarController;
...
- (LKSMXCTabBarController *)tabBarController{
    if (!_tabBarController) {
        _tabBarController = [[LKSMXCTabBarController alloc]init];
    }
...
- (void)LUCK_showPasswordVC{
    ...
    self.window.rootViewController = pwd;
}
